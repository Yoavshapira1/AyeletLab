...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 603.0, 817.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 266.5, 835.0, 123.0, 22.0 ],
					"text" : "scale 0. 1. 100 22000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.5, 843.0, 82.0, 22.0 ],
					"text" : "r EnvOpening"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 280.0, 315.0, 84.0, 22.0 ],
					"text" : "s EnvOpening"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 166.0, 900.0, 65.0, 22.0 ],
					"text" : "append 20"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 165.0, 929.0, 34.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "1 3 5 7 12 15 17 19 21 25 27 28"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 272.0, 797.0, 60.0, 22.0 ],
					"text" : "r Xcurpos"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 183.75, 315.0, 62.0, 22.0 ],
					"text" : "s Xcurpos"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 159.0, 513.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.5, 525.0, 90.0, 22.0 ],
					"text" : "scale 0. 1. 1 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.5, 497.0, 66.0, 22.0 ],
					"text" : "r Ystartpos"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 62.75, 321.0, 68.0, 22.0 ],
					"text" : "s Ystartpos"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 411.75, 254.0, 50.0, 20.0 ],
					"text" : "\"Mode\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 350.75, 254.0, 50.0, 20.0 ],
					"text" : "Sustain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 63.0, 59.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 62.75, 187.0, 101.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 62.75, 155.0, 91.0, 22.0 ],
					"text" : "route /channel1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 62.75, 89.0, 59.0, 22.0 ],
					"text" : "port 2222"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 62.75, 122.0, 105.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 65.5, 87.0, 150.0, 20.0 ],
					"text" : "Tuning"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 59.5, 569.0, 56.0, 22.0 ],
					"text" : "zl.lookup"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 59.5, 621.341773999999987, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 59.5, 655.993668000000071, 59.0, 22.0 ],
					"style" : "newobjBlue",
					"text" : "poly 16 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "", "" ],
					"patching_rect" : [ 59.5, 758.563292999999931, 136.0, 22.0 ],
					"style" : "newobjYellow",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 46.0, 58.0, 780.0, 286.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 160.0, 649.063292999999931, 109.0, 649.063292999999931 ],
					"source" : [ "obj-11", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 203.5, 579.0, 150.0, 579.0 ],
					"source" : [ "obj-25", 0 ]
				}
